...
| **Dates** | All dates formatted as MM/DD/YYYY |
    ...
    if st.session_state.get(show_key):
        ...
        with col_dl3:
            st.download_button(label="📋 Download Change Log & Issues (XLSX)", data=cached.get("audit", b""), file_name=f"Paycom_Change_Log_and_Issues_{stamp}.xlsx", mime="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", key="pc_sanity_dl_audit")
